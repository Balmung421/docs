...
export declare type NodeType = 'document' | 'heading' | 'paragraph' | 'blockquote' | 'hr' | 'image' | 'fence' | 'tag' | 'list' | 'item' | 'table' | 'thead' | 'tbody' | 'tr' | 'td' | 'th' | 'inline' | 'strong' | 'em' | 's' | 'link' | 'code' | 'text' | 'hardbreak' | 'softbreak';
